...
create table user_account (
    ...
    gender text not null check (gender = 'male' or gender = 'female' or gender = 'not_say') default 'not_say',
    date_of_birth date not null,
    unique (id, user_role)
);

create table user_customer (
    user_id varchar(36) primary key references user_account(id) on delete cascade,
...
create table vote (
    ...
    created_at timestamp not null default current_timestamp,
    created_by varchar(36) null references user_customer(user_id) on delete cascade,
